		...
		<div class="right-details">
			<div>
				<ul class="server-reqirement">
					...
					<li class="<?= array_key_exists('imagick', $serverReq) ? 'error' : 'success' ?>" >imagick</li>
					<li class="<?= array_key_exists('gmp', $serverReq) ? 'error' : 'success' ?>" >gmp</li>
					<li class="<?= array_key_exists('fileinfo', $serverReq) ? 'error' : 'success' ?>" >fileinfo</li>
					<li class="<?= array_key_exists('JSON', $serverReq) ? 'error' : 'success' ?>" >JSON</li>
					<li class="<?= array_key_exists('mbstring', $serverReq) ? 'error' : 'success' ?>" >mbstring</li>
