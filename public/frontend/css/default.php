...
<?php if (isset($themes) && $themes ==2) : ?>.homeItemDetails.list_view .itemPrice_area.i_small {
	flex-wrap: nowrap;
	white-space: nowrap;
	overflow-x: auto;
}
...
<?php if (isset($themes) && $themes ==3) : ?><?php endif ?>button.btn.btn-primary.add_to_cart_btn:hover {
	background: #fff !important;
	color: rgba(<?=hex2rgb($hex_color); ?>, 1) !important;
