...
--
-- Host: localhost:3306
-- Generation Time: May 21, 2024 at 04:37 PM
...
(533, 'confirm_oder', 'admin', '', 'confirm oder', 'تأكيد الطلب', 'confirmar orden'),
...
--
-- Constraints for table `staff_order_activity_logs`
--
ALTER TABLE `staff_order_activity_logs`
  ADD CONSTRAINT `staff_order_activity_logs_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order_user_list` (`id`),
  ADD CONSTRAINT `staff_order_activity_logs_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff_list` (`id`);
COMMIT;
