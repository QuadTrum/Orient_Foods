			...
			<div class="homeItem_left">
				...
				<div class="port_d_flex home_view space-between">
					...
					<?php if (shop($row['shop_id'])->is_cart == 1) : ?>
						<a href="javascript:;" class="quick_view" data-id="<?= html_escape($row['item_id']); ?>" data-offer="<?= isset($offer_discount) ? $offer_discount : 0; ?>" data-type="item" data-placement="top" data-toggle="" title="Add to Cart"><i class="fa-solid fa-bag-shopping"></i> <span><?= lang('add'); ?></span></a>
					<?php endif; ?> <!-- is cart -->
