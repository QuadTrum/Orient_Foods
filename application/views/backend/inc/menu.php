    ...
    <div class="rightMenuBar">
      ...
      <?php if ($auth_info['user_role'] == 0) : ?>
        <a href="<?= url(html_escape($this->my_info['username'])); ?>" class="navLink" target='blank'>
          <i class="fa fa-eye"></i> <span class="hidden-xs"><?= !empty(lang('view_shop')) ? lang('view_shop') : ""; ?></span>
        </a>
      <?php endif; ?>
    </div>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <?php foreach ($shop_languages as $key => $language) : ?>
                    <li>
                      <a class="dropdown-item" href="<?= base_url('home/lang_switch/'. $language->slug.'/restaurant_admin_lang'); ?>">
                        <span class="mr-2 <?=
