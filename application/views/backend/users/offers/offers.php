...
<?php foreach ($offer_list as  $key => $row) : ?>
    <div id="edit_<?= $row['id']; ?>" class="modal fade customModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="<?= base_url("admin/coupon/add_offers") ?>" method="post" enctype="multipart/form-data">
                <?= csrf(); ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="start_date" class="form-control datepicker" placeholder="<?= __('start_date') ?>" required value="<?= !empty($row['start_date']) ? $row['start_date'] : ''; ?>">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="name"><?= __('end_date') ?> <span class="error">*</span></label>
                                <input type="text" name="end_date" class="form-control datepicker" placeholder="<?= __('end_date') ?>" required value="<?= !empty($row['end_date']) ? $row['end_date'] : ''; ?>">
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="name"><?= __('start_date') ?> <span class="error">*</span></label>
                            <input type="text" name="start_date" class="form-control datepicker" placeholder="<?= __('start_date') ?>" required>
                        </div>

                        <div class="form-group col-md-6">
                            <label for="name"><?= __('end_date') ?> <span class="error">*</span></label>
                            <input type="text" name="end_date" class="form-control datepicker" placeholder="<?= __('end_date') ?>" required>
                        </div>
                    </div>
