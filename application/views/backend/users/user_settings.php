                    ...
                    <div class="row p-15">
                        <div class="email_areas">
                            <div class="email_content">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="">
                                            <select name="email_type" class="form-control email_option">
                                                <option value="2" <?= isset($settings['email_type']) && $settings['email_type'] == 2 ? 'selected' : '' ?>>
                                                    <?= lang('smtp'); ?></option>
                                ...
                                <div class="row ">
                                    <div class="MailTrap" style="display: <?= isset($settings['email_type']) && $settings['email_type'] == 1 ? 'block' : 'none' ?>;">
                                        <div class="form-group col-md-12">
