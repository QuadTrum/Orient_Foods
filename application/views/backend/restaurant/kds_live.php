<link rel="stylesheet" href="<?= base_url("public/admin/kds.css")?>?t=<?= time();?>">
...
<?php endif ?>
<?php endif ?>
<script src="<?php echo base_url()?>public/admin/kds_pusher.js?v=<?= settings()['version'];?>&time=<?= time();?>"></script>