					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<select name="section_name" id="" class="form-control section_name">
								...
								<option value="about_us_first" <?= isset($data['section_name']) && $data['section_name'] == 'about_us_first' ? "selected" : ""; ?>>
									<?= !empty(lang('about_us_first')) ? lang('about_us_first') : "about_us_first"; ?> <?= lang('section'); ?>

								</option>

								<option value="about_us_second" <?= isset($data['section_name']) && $data['section_name'] == 'about_us_second' ? "selected" : ""; ?>>
									<?= !empty(lang('about_us_second')) ? lang('about_us_second') : "Contacts"; ?> <?= lang('section'); ?>

								</option>
								<option value="about_us_third" <?= isset($data['section_name']) && $data['section_name'] == 'about_us_third' ? "selected" : ""; ?>>
