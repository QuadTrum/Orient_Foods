                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <select name="number_formats" class="form-control">
                                <option value="0"
                                    <?= isset($settings['number_formats']) && $settings['number_formats']== 0?"selected":"";  ;?>>
                                    100</option>
                                <option value="1"
                                    <?= isset($settings['number_formats']) && $settings['number_formats']== 1?"selected":"";  ;?>>
                                    1000.00</option>
                                <option value="2"
                                    <?= isset($settings['number_formats']) && $settings['number_formats']== 2?"selected":"";  ;?>>
                                    1.000,00</option>
                                <option value="3"
                                    <?= isset($settings['number_formats']) && $settings['number_formats']== 3?"selected":"";  ;?>>
                                    1,000.00</option>
                            </select>
                        </div>
                    </div>
