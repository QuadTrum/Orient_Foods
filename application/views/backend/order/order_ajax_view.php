            ...
            <div class="topOrderView">
                ...
                <div class="mt-10 action_btn_area">
                    ...
                    <?php elseif ($order['status'] == 1) : ?>
                        <a href="javascript:;" class="btn info-light-active" data-shop="<?= $order['shop_id']; ?>" data-toggle="tooltip" title="Mark as Accept"><i class="fa fa-check"></i> &nbsp;
                            <?= lang('accept'); ?> </a> &nbsp;

                        <a href="<?= base_url('admin/restaurant/order_status_by_ajax/' . $order['uid']) . '/2'; ?>" data-shop="<?= $order['shop_id']; ?>" class="btn success-light orderStatus" data-toggle="tooltip" title="Mark as Completed"><i class="icofont-hand-drag1"></i> &nbsp; <?= lang('completed'); ?> </a>
                        &nbsp;
                    <?php elseif ($order['status'] == 2) : ?>
                        <a href="javascript:;" class="btn info-light-active" data-toggle="tooltip" data-shop="<?= $order['shop_id']; ?>" title="Accepted"><i class="fa fa-check"></i> &nbsp;
                            <?= lang('accepted'); ?> </a> &nbsp;

                        <a href="javascript:;" class="btn success-light-active" data-toggle="tooltip" data-shop="<?= $order['shop_id']; ?>" title="Completed"><i class="fa fa-check"></i> &nbsp;
                            <?= lang('completed'); ?> </a> &nbsp;

                    <?php elseif ($order['status'] == 3) : ?>
                        <a href="javascript:;" class="btn danger-light-active" data-toggle="tooltip" data-shop="<?= $order['shop_id']; ?>" title="Cancled"><i class="fa fa-check"></i> &nbsp;
                            <?= lang('cancled'); ?> </a> &nbsp;
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <?php else : ?>
                        <div class="singleItem">
                            <div class="topSingleItem">
                                ...
                                <div class="singleItemDetails">
                                    <h4> <?= html_escape($row['title']); ?> <label class="label " data-toggle="tooltip" title="<?= veg_type($row['veg_type']); ?>"><i class="fa fa-square <?= $row['veg_type'] == 1 ? "c-success" : "c-danger"; ?>"></i></label>
                                    </h4>
