	...
	<?php if (isset($is_filter) && $is_filter == TRUE) : ?>
		<ul class="dropdown-menu dropdown-ul" role="menu">
			...
			<?php if ($row['is_payment'] == 0 ) : ?>
				...
				<li class="cl-success-soft"><a href="<?= base_url('admin/restaurant/order_payment_status/' . $row['id']) . '/1'; ?>" data-shop="<?= $row['shop_id']; ?>" class="" data-toggle="tooltip" title="Mark as Completed"><i class="icofont-hand-drag1"></i> &nbsp; <?= lang('completed_paid'); ?> </a></li>
			<?php endif; ?>
