      ...
      <div class="row">
        ...
        <div class=" col-4 col-sm-4 col-lg-4">
          <div class="left_footer">
            ...
            <ul class="row_ul">
              <li><a class="linksFooter" href="<?= base_url(); ?>"><i class="icofont-simple-right"></i> <?= !empty(lang('home')) ? lang('home') : "home"; ?></a></li>
              <?php if ($settings['is_user'] == 1): ?>
                <li><a class="linksFooter" href="<?= base_url('users'); ?>"><i class="icofont-simple-right"></i> <?= !empty(lang('users')) ? lang('users') : "users"; ?></a></li>
              <?php endif; ?>

              <?php if (!empty(section_name('contacts')) && section_name('contacts')['status'] == 1): ?>
                <li><a class="linksFooter" href="<?= base_url('contacts'); ?>"><i class="icofont-simple-right"></i> <?= !empty(lang('contacts')) ? lang('contacts') : "contacts"; ?></a></li>
              <?php endif; ?>
              ...
              <?php if (isset($terms['status']) && $terms['status'] == 1): ?>
                <li><a class="linksFooter" href="<?= base_url('terms-conditions'); ?>" target="blank"><i class="icofont-simple-right"></i> <?= !empty(lang('terms_condition')) ? lang('terms_condition') : "Terms & Condition"; ?></a></li>
              <?php endif; ?>

              <?php if (isset($privacy['status']) && $privacy['status'] == 1): ?>
                <li><a class="linksFooter" href="<?= base_url('cookies-privacy'); ?>" target="blank"><i class="icofont-simple-right"></i> <?= !empty(lang('cookies_privacy')) ? lang('cookies_privacy') : "privacy & cookie"; ?> </a></li>
              <?php endif; ?>
            </ul>
          </div>
        </div>
