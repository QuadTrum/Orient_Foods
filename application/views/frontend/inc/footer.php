...
<script>
    ...
    window.onload = function() {
        ...
        <script src="<?php echo base_url() ?>assets/frontend/plugins/slickSlider/slick.min.js" defer="true"></script>
        <script src="<?php echo base_url() ?>assets/frontend/plugins/swiper/swiper.js" defer="true"></script>
        <!-- slick slider js -->
...
<script type="text/javascript">
    ...
    $(document).on("click", ".whatsappIconBtnMobile", function() {
        $('.whatsappSupportWindow').toggleClass('active');
    });
</script>
...
<?php if (isset($shop_id)) : ?>
    <?php $days = get_days(); ?>
    <?php $available_type = isset($shop_info->available_type) ? $shop_info->available_type : 'close'; ?>
    <?php if (isset($days) && !empty($days)) : ?>
    <?php $icon = isset($shop_info->available_type) && $shop_info->available_type == 'open' ? 'icofont-wall-clock' : 'icofont-close-line text-danger'; ?>
    <!-- Modal -->
                ...
                <div class="modal-body pt-5">
                    <div class="availableDayList">
                        ...
                        foreach ($days as $key => $day) : ?>
                            ...
                            <div class="singleDayList <?= $available_type; ?>">
